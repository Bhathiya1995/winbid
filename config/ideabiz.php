...
return [
    ...
    */
    ...
    |
    */
    'username' => env('IDEABIZ_USERNAME', 'hydeparksl'),
    'password' => env('IDEABIZ_PASSWORD', 'Hemantha@2021'),
    ...
    */
    'production' => [
        ...
        'grant_type'      => 'password',
        'scope'           => 'PRODUCTION',
        'consumer_key'    => env('IDEABIZ_PRODUCTION_CONSUMER_KEY', 'fEcMwsV7MepiVdo0pEpQRX4SLgca'),
        'consumer_secret' => env('IDEABIZ_PRODUCTION_CONSUMER_SECRET', 'OwlAzWAfftxntfCXregSfRCTbvga'),
    ],
